...
const TESTIMONIALS = [
  ...
  {
    id: 5,
    name: "Medina Hussen Brahim",
    location: "Now in Saudi- Riyadh and Abha",
    avatar: "MH",
  ...
  {
    id: 6,
    name: "Firehiwot woldetsadik Argaw",
    location: "Now in Dubai",
    avatar: "FW",
    color: "from-teal-500/20 to-teal-500/5",
    text: "A truly transparent and dedicated team. My transition to working abroad was smooth, and I am very happy with my current employer.",
    rating: 5,
  },
];
