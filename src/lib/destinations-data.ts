...
export const DESTINATIONS_DATA: DestinationData[] = [
  ...
  /* ─────────────── QATAR ─────────────── */
  {
    ...
    climate:     "Hot & Humid",
    heroImage:
      "https://images.unsplash.com/photo-1507272931001-fc06c17e4f43?w=1200&q=85",
    galleryImages: [
  ...
  /* ─────────────── KUWAIT ─────────────── */
  {
    ...
    climate:     "Hot & Arid",
    heroImage:
      "https://images.unsplash.com/photo-1519458246479-e07a67e3d4f5?w=1200&q=85",
    galleryImages: [
  ...
  /* ─────────────── BAHRAIN ─────────────── */
  {
    ...
    climate:     "Hot & Humid",
    heroImage:
      "https://images.unsplash.com/photo-1579820010410-c10411aaaa88?w=1200&q=85",
    galleryImages: [
      "https://images.unsplash.com/photo-1565073624497-7144969d0db5?w=600&q=80",
    ...
    tagline: {
      en: "Gateway to the Gulf — Modern & Welcoming",
      am: "ወደ ባህረሰላጤ መዳረሻ — ዘመናዊ እና ደህና",
      om: "Karaa Gulf — Ammayyaa fi Simatu",
    },
    description: {
      en: "Bahrain is the most liberal and open economy in the Gulf, making it an excellent entry point for Ethiopian workers new to the Gulf experience. With a thriving financial sector, tourism industry, and numerous service opportunities, Bahrain offers a welcoming environment.",
      am: "ባህሬን በባህረሰላጤ ውስጥ በጣም ነፃ እና ክፍት ኢኮኖሚ ሲሆን ይህም ለጉልፍ ተሞክሮ አዲስ ለሆኑ ኢትዮጵያ ሰራተኞች ምርጥ ጅምር ቦታ ያደርገዋል። ፈጣን የፋይናንስ ዘርፍ፣ የቱሪዝም ኢንዱስትሪ እና ብዙ የአገልግሎት ዕድሎች ጋር፣ ባህሬን ደህናምሉ አካባቢ ይሰጣል።",
      om: "Baahireyn dinagdee bilisaa fi banaa baay'ee Gulf keessatti waan ta'eef, hojjattoota Itoophiyaa muuxannoo Gulf irratti haaraa ta'aniif bakka jalqabaa olaanaadha. Gatiin faayinaansii saffisaan guddata, industirii turizimii fi carraalee tajaajilaa hedduun waliin, Baahireyn naannoo simatu dhiheessa.",
    },
    highlights: {
      en: [
        "Most open and liberal Gulf economy",
        "Lower cost of living vs other Gulf states",
        "Strong English proficiency widely spoken",
        "Excellent work-life balance",
        "Close-knit expat community",
        "Easy to navigate as a first Gulf destination",
      ],
      am: [
        "እጅግ ክፍት እና ነፃ የባህረሰላጤ ኢኮኖሚ",
        "ከሌሎቹ የባህረሰላጤ ሀገሮች ጋር ዝቅተኛ ኑሮ ወጪ",
        "ጥሩ እንግሊዝኛ ብቃት ሰፊ ቦታ ይነገራል",
        "ምርጥ የሥራ-ሕይወት ሚዛን",
        "ቅርበት ያለው የምናባዊ ማህበረሰብ",
        "እንደ የመጀመሪያ የባህረሰላጤ መድረሻ ለመምራት ቀላል",
      ],
      om: [
        "Dinagdee Gulf banaa fi bilisaa baay'ee",
        "Baasii jireenyaa gad VS biyyoota Gulf biroo",
        "Dandeettii Inglizii gaarii bal'inaan dubbatama",
        "Walitti dhufeenya hojii-jireenya gaarii",
        "Hawaasa biyyoota ala jiranii dhihoo",
        "Bakka dhuma Gulf jalqabaa ta'uun salphaa",
      ],
    },
    jobCategories: [
      { name: { en: "Domestic Workers",     am: "የቤት ሰራተኞች",       om: "Hojjattoota Mana"            }, openings: 350,  salary: { min: 300,  max: 500  }, icon: "🏠" },
      { name: { en: "Hospitality Staff",    am: "የማስተናገጃ ሰራተኞች",  om: "Hojjattoota Keessummeessaa"  }, openings: 200,  salary: { min: 400,  max: 750  }, icon: "🍽️" },
      { name: { en: "Security Guards",      am: "የደህንነት ጠባቂዎች",   om: "Tiksitoota Nageenyaa"         }, openings: 150,  salary: { min: 400,  max: 650  }, icon: "🛡️" },
      { name: { en: "Healthcare Workers",   am: "የጤና ሰራተኞች",      om: "Hojjattoota Fayyaa"           }, openings: 100,  salary: { min: 600,  max: 900  }, icon: "🏥" },
    ],
    requirements: {
      en: [
        "Valid Ethiopian passport (6+ months)",
        ...
        "Relevant experience or training certificates",
      ],
      am: [
        "ትክክለኛ ፓስፖርት (6+ ወር)",
        "ዕድሜ 21–45",
        "የሕክምና ብቃት ሰርተፍኬት",
        "የፖሊስ ማጽዳት ሰነድ",
        "የእንግሊዝኛ ግንኙነት ቢኖር ጠቃሚ ነው",
        "ተዛማጅ ልምድ ወይም ሥልጠና ሰርተፍኬቶች",
      ],
      om: [
        "Paaspoortii sirrii (ji'a 6+)",
        "Umrii 21–45",
        "Waraqaa ragaa dandeettii fayyaa",
        "Sanadaa qulqulleessa poolisii",
        "Dubbii Inglizii faaydaa qaba",
        "Waraqaalee ragaa muuxannoo ykn leenjii walqabatu",
      ],
    },
    livingInfo: {
      en: [
        { label: "Currency",       value: "BHD (1 BHD ≈ 290 ETB)"   },
        { label: "Language",       value: "Arabic / English"         },
        { label: "Time Zone",      value: "GMT+3"                    },
        { label: "Climate",        value: "Hot & humid (28–45°C)"    },
        { label: "Accommodation",  value: "Usually employer-provided" },
        { label: "Lifestyle",      value: "Most relaxed Gulf lifestyle" },
        { label: "Healthcare",     value: "Good hospitals and clinics" },
        { label: "Transport",      value: "Buses, taxis, ride-sharing" },
      ],
      am: [
        { label: "ምንዛሬ",         value: "BHD (1 BHD ≈ 290 ብር)"    },
        { label: "ቋንቋ",          value: "አረብኛ / እንግሊዝኛ"           },
        { label: "ሰዓት ዞን",       value: "GMT+3"                    },
        { label: "ወቅት",          value: "ሞቃት እና እርጥብ (28–45°C)"   },
        { label: "መኖሪያ",         value: "ብዙ ጊዜ ቀጣሪ ይሰጣል"          },
        { label: "የኑሮ ስልት",      value: "ቀናዳ ዘና ያለ የባህረሰላጤ ህይወት"  },
        { label: "ጤና",           value: "ጥሩ ሆስፒታሎች እና ክሊኒኮች"     },
        { label: "ትራንስፖርት",     value: "አውቶቡስ፣ ታክሲ፣ ራይድ-ሼሪንግ"   },
      ],
      om: [
        { label: "Maallaqaa",      value: "BHD (1 BHD ≈ ETB 290)"   },
        { label: "Afaan",          value: "Arabaa / Inglizii"        },
        { label: "Zoom Yeroo",     value: "GMT+3"                    },
        { label: "Qilleensa",      value: "Ho'aa fi jiidha (28–45°C)" },
        { label: "Mana Jireenyaa", value: "Hedduun qaxarsiisaan kenna" },
        { label: "Jireenyaa",      value: "Jireenya Gulf tasgabbaa'aa" },
        { label: "Fayyaa",         value: "Hospitaalota fi kliinikiiwwan gaarii" },
        { label: "Geejjiba",       value: "Konkolaataa, taaksii, ride-sharing" },
      ],
    },
    workerTestimonial: {
      name:     "Fatuma Ahmed",
      avatar:   "FA",
      duration: "14 months in Bahrain",
      text: {
        en: "Bahrain was perfect for me as my first Gulf experience. The people are friendly, the work is manageable, and I felt safe throughout. Luluat Alsharq was honest and transparent about everything from day one.",
        am: "ባህሬን ለኔ እንደ የመጀመሪያ የባህረሰላጤ ተሞክሮ ፍጹም ነበር። ሰዎቹ ወዳጃዊ ናቸው፣ ሥራው አስተዳዳሪ ነው፣ እና ሁሉም ጊዜ ደህንነቱ ተሰምቶኛል። ሉሉአት አልሸርቅ ከቀን አንድ ሁሉ ነገር ላይ ቅን እና ግልፅ ነበር።",
        om: "Baahireyn naaf muuxannoo Gulf jalqabaa akkuma filannootti ta'e. Namooti michoomsaa dha, hojiin raawwatamaa dha, fi yeroo hunda nagaa itti dhagaye. Luluat Alsharq guyyaa tokkoo kaasee waa hunda irratti dhugaa fi ifaa ture.",
      },
      rating: 5,
    },
  },
